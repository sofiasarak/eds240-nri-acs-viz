...
This repository contains visualizations summarizing NRI ([National Risk Index](https://www.fema.gov/flood-maps/products-tools/national-risk-index)) and ([ACS](https://www.census.gov/programs-surveys/acs/about.html)) data for the 50 US states. This analysis was completed for homework assignments 2 and 3 for MEDS course EDS240: Data Visualization & Communication.
